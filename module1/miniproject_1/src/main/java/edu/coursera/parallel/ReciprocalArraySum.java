...
public final class ReciprocalArraySum {
    ...
    protected static double parManyTaskArraySum(final double[] input,
            final int numTasks) {
        System.setProperty("java.util.concurrent.ForkJoinPool.common.parallelism", String.valueOf(6));
        ...
        for (int i = 0; i <numTasks ; i++) {
            ...
            int beg=getChunkStartInclusive(i,numTasks,len);
            int end=getChunkEndExclusive(i,numTasks,len);
            ReciprocalArraySumTask t=new ReciprocalArraySumTask(beg,end,input);
            ForkJoinPool.commonPool().invoke(t);
            sum += t.getValue();
        }
